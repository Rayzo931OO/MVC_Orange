...
foreach ($materiels as $materiel) {
   ...
   if ($_SESSION['role'] == "admin" || $_SESSION['role'] == "client") {
      ...
      <td class='actions'>
      <button><a href='index.php?action=edit&id=" . $materiel['id'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                      ...
                      </svg></a></button><button class='delete'><a href='index.php?action=delete&id=" . $materiel['id'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
