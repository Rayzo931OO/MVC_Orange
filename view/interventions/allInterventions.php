...
foreach ($interventions as $intervention) {
    ...
    $technicien = selectUserById($intervention['technicien_id']);

    echo "<tr>
      <td>" . $materiel['nom'] . "</td>
      <td>" . $technicien['nom'] . " " . $technicien['prenom'] . "</td>
      <td>" . $intervention['fournisseur'] . "</td>
      <td>" . $intervention['date_debut'] . "</td>
      <td>" . $intervention['date_fin'] . "</td>
      <td>" . $intervention['status'] . "</td>
      <td>" . $intervention['description'] . "</td>
      <td class='actions'>
      <button><a href='index.php?action=edit&id=" . $intervention['id'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                      ...
                      </svg></a></button><button class='delete'><a href='index.php?action=delete&id=" . $intervention['id'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
