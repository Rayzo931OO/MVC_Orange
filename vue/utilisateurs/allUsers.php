...
foreach ($users as $user) {
    if ($user['id_utilisateur'] == $_SESSION['id']) {
        ...
        echo "<tr>
                 ...
                 <td>" . $user['role'] . "</td>
                 <td class='actions'>
                 <button><a href='index.php?action=edit&id=" . $user['id_utilisateur'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                                 ...
                                 if ($_SESSION["role"] == "admin" || $_SESSION["role"] == "superviseur") {
                                     echo "<button class='delete'><a href='index.php?action=delete&id=" . $user['id_utilisateur'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
