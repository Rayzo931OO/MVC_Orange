...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    switch ($action) {
        case 'edit':
            $materiel = $logicielController->selectMaterielById($id);
            require_once('editMaterielForm.php');
            break;
        case 'delete':
            $logicielController->deleteMaterielById($id);
    ...
    if (!isset($_POST["formMateriel"]) && !isset($_POST["Recherchez"])) {
        ...
        $materiels = $logicielController->AllMateriel();
    ...
    if (isset($_POST["Ajoutez"])) {
        $logicielController->ajouterMateriel($_POST);
        header('Location: index.php');
    }
}
if (isset($_POST['Modifier'])) {
    var_dump($_POST);
    $logicielController->updateMateriel($_POST);
    header('Location: index.php');
}
?>
