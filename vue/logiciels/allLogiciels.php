...
echo "<br><table class='tableau' border-collapse='collapse'>
        <caption class='caption'>Listes des logiciels</caption>
        <thead>
            <tr>
                <th>Nom</th>
                <th>Description</th>
...
foreach ($logiciels as $logiciel) {
   if (substr($_SESSION["role"], 0, 5) == "admin" || $_SESSION["role"] == "superviseur" || $_SESSION['role'] == "technicien") {
      ...
      <button><a href='index.php?action=edit&id=" . $logiciel['id_logiciel'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                      ...
                      </svg></a></button><button class='delete'><a href='index.php?action=delete&id=" . $logiciel['id_logiciel'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
