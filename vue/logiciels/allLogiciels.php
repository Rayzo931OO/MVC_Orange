...
echo "<br><table class='tableau' border-collapse='collapse'>
        <caption class='caption'>Listes des materiels</caption>
        <thead>
            <tr>
                <th>Nom</th>
                <th>Description</th>
...
foreach ($materiels as $materiel) {
   if (substr($_SESSION["role"], 0, 5) == "admin" || $_SESSION['role'] == "client") {
      ...
      <td>" . $categorieController->selectCategorieById($materiel['id_categorie'])["nom"] . "</td>
      <td class='actions'>
      <button><a href='index.php?action=edit&id=" . $materiel['id_materiel'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                      ...
                      </svg></a></button><button class='delete'><a href='index.php?action=delete&id=" . $materiel['id_materiel'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
