...
echo "<br><table class='tableau' border-collapse='collapse'>
        <caption class='caption'>Listes des categories</caption>
        <thead>
            <tr>
                <th>Nom</th>
                <th>Description</th>
...
foreach ($categories as $categorie) {
   if (substr($_SESSION["role"], 0, 5) == "admin" || $_SESSION['role'] == "client") {
      ...
      <td class='actions'>
      <button><a href='index.php?action=edit&id=" . $categorie['id_categorie'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                      ...
                      </svg></a></button><button class='delete'><a href='index.php?action=delete&id=" . $categorie['id_categorie'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
