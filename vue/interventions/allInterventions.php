...
foreach ($interventions as $intervention) {
    ...
    echo "<tr>
      ...
      <button><a href='index.php?action=edit&id=" . $intervention['id_intervention'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
                      ...
                      </svg></a></button><button class='delete'><a href='index.php?action=delete&id=" . $intervention['id_intervention'] . "'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24'>
